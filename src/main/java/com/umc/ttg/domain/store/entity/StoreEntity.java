...
public class StoreEntity extends Time {
    ...
    @Builder
    private StoreEntity(StoreRequestDto storeRequestDto, MenuEntity menu, RegionEntity region, String storeImage) {
    ...
    public void update(StoreRequestDto storeRequestDto, MenuEntity menuEntity, RegionEntity regionEntity, String storeImage) {
        this.title = storeRequestDto.getTitle();
        this.subTitle = storeRequestDto.getSubTitle();
        this.useInfo = storeRequestDto.getUseInfo();
        this.saleInfo = storeRequestDto.getSaleInfo();
